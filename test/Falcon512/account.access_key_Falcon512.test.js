...
test('make function call using access key (FALCON512)', async() => {
    const keyPair = nearApi.utils.KeyPair.fromRandom('falcon512');
...
test('remove access key no longer works (FALCON512)', async() => {
    const keyPair = nearApi.utils.KeyPair.fromRandom('falcon512');
...
test('view account details after adding access keys (FALCON512)', async() => {
    const keyPair = nearApi.utils.KeyPair.fromRandom('falcon512');
    ...
    const keyPair2 = nearApi.utils.KeyPair.fromRandom('falcon512');
...
test('loading account after adding a full key (FALCON512)', async() => {
    const keyPair = nearApi.utils.KeyPair.fromRandom('falcon512');
