...
const testUtils  = require('./test-utils-falcon512');
const fs = require('fs');
...
test('view pre-defined account works and returns correct name (FALCON512)', async () => {
    let status = await workingAccount.state();
    expect(status.code_hash).toEqual('11111111111111111111111111111111');
});

test('create account and then view account returns the created account (FALCON512)', async () => {
    const newAccountName = testUtils.generateUniqueString('test');
    const newAccountPublicKey = 'falcon512:';
...
test('send money (FALCON512)', async() => {
...
test('delete account (FALCON512)', async() => {
    const sender = await testUtils.createAccount(nearjs);
    const receiver = await testUtils.createAccount(nearjs);
...
test('multiple parallel transactions (FALCON512)', async () => {
...
test('findAccessKey returns the same access key when fetched simultaneously (FALCON512)', async() => {
    //FALCON512
...
describe('errors (FALCON512)', () => {
    ...
    test('create existing account (FALCON512)', async() => {
        await expect(workingAccount.createAccount(workingAccount.accountId, 'falcon512:', 100))
            .rejects.toThrow(/Can't create a new account .+, because it already exists/);
    });
});

describe('with deploy contract (FALCON512)', () => {
    let oldLog;
    let logs;
    ...
    beforeAll(async () => {
        const newPublicKey = await nearjs.connection.signer.createKey(contractId, testUtils.networkId, key_pair.KeyType.FALCON512);
