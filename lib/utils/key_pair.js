...
exports.KeyPairFalcon512 = exports.KeyPairEd25519 = exports.KeyPair = exports.PublicKey = exports.KeyType = void 0;
...
(function (KeyType) {
    ...
    KeyType[KeyType["FALCON512"] = 1] = "FALCON512";
...
class PublicKey extends enums_1.Assignable {
    ...
    verify(message, signature) {
        switch (this.keyType) {
            ...
            case KeyType.FALCON512: return crypto_falcon_js_1.falcon.verifyDetached(signature, message, this.data);
