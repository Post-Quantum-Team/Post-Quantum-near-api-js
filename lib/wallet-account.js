...
class WalletConnection {
     ...
     * ```
     */
    async requestSignIn(contractIdOrOptions = {}, title, successUrl, failureUrl, keyType) {
        let options;
        ...
        if (options.contractId) {
            ...
            let accessKey;
            switch (keyType) {
                case utils_1.KeyType.ED25519:
                    accessKey = utils_1.KeyPair.fromRandom('ed25519');
                    break;
                case utils_1.KeyType.FALCON512:
                    accessKey = utils_1.KeyPair.fromRandom('falcon512');
                    break;
                default:
                    accessKey = utils_1.KeyPair.fromRandom('ed25519');
            }
