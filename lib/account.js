...
class Account {
    ...
    /** @hidden */
    get ready() {
        const deprecate = (0, depd_1.default)('Account.ready()');
    ...
    async fetchState() {
        const deprecate = (0, depd_1.default)('Account.fetchState()');
    ...
    async signTransaction(receiverId, actions) {
        ...
        return await (0, transaction_1.signTransaction)(receiverId, nonce, actions, (0, borsh_1.baseDecode)(blockHash), this.connection.signer, this.accountId, this.connection.networkId);
    }
    ...
    signAndSendTransactionV1(receiverId, actions) {
        const deprecate = (0, depd_1.default)('Account.signAndSendTransaction(receiverId, actions');
    ...
    async signAndSendTransactionV2({ receiverId, actions, returnError }) {
        ...
        const result = await (0, exponential_backoff_1.default)(TX_NONCE_RETRY_WAIT, TX_NONCE_RETRY_NUMBER, TX_NONCE_RETRY_WAIT_BACKOFF, async () => {
    ...
    functionCallV1(contractId, methodName, args, gas, amount) {
        const deprecate = (0, depd_1.default)('Account.functionCall(contractId, methodName, args, gas, amount)');
        deprecate('use `Account.functionCall(FunctionCallOptions)` instead');
        args = args || {};
        this.validateArgs(args);
        return this.signAndSendTransaction({
            receiverId: contractId,
            actions: [(0, transaction_1.functionCall)(methodName, args, gas || constants_1.DEFAULT_FUNCTION_CALL_GAS, amount)]
        });
    }
