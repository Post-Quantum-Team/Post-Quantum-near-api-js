...
class JsonRpcProvider extends provider_1.Provider {
    ...
    constructor(connectionInfoOrUrl) {
        ...
        if (connectionInfoOrUrl != null && typeof connectionInfoOrUrl == 'object') {
            ...
            const deprecate = (0, depd_1.default)('JsonRpcProvider(url?: string)');
    ...
    async block(blockQuery) {
        ...
        if (typeof blockQuery !== 'object') {
            const deprecate = (0, depd_1.default)('JsonRpcProvider.block(blockId)');
    ...
    async experimental_genesisConfig() {
        const deprecate = (0, depd_1.default)('JsonRpcProvider.experimental_protocolConfig()');
    ...
    async experimental_lightClientProof(request) {
        const deprecate = (0, depd_1.default)('JsonRpcProvider.experimental_lightClientProof(request)');
    ...
    async sendJsonRpc(method, params) {
        const response = await (0, exponential_backoff_1.default)(REQUEST_RETRY_WAIT, REQUEST_RETRY_NUMBER, REQUEST_RETRY_WAIT_BACKOFF, async () => {
            try {
                const request = {
                    method,
                    params,
                ...
                const response = await (0, web_1.fetchJson)(this.connection, JSON.stringify(request));
                if (response.error) {
