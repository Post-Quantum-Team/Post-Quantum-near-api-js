...
exports.signTransaction = exports.createTransaction = exports.SCHEMA = exports.Action = exports.SignedTransaction = exports.Transaction = exports.SignatureFalcon512 = exports.SignatureEd25519 = exports.Signature = exports.deleteAccount = exports.deleteKey = exports.addKey = exports.stake = exports.transfer = exports.functionCall = exports.stringifyJsonOrBytes = exports.deployContract = exports.createAccount = exports.DeleteAccount = exports.DeleteKey = exports.AddKey = exports.Stake = exports.Transfer = exports.FunctionCall = exports.DeployContract = exports.CreateAccount = exports.IAction = exports.functionCallAccessKey = exports.fullAccessKey = exports.AccessKey = exports.AccessKeyPermission = exports.FullAccessPermission = exports.FunctionCallPermission = void 0;
...
exports.SignatureEd25519 = SignatureEd25519;
class SignatureFalcon512 extends Signature {
}
exports.SignatureFalcon512 = SignatureFalcon512;
...
exports.SCHEMA = new Map([
    ...
    [Transaction, { kind: 'struct', fields: [
                ['signerId', 'string'],
                ['publicKey', key_pair_1.PublicKeyEd25519 || key_pair_1.PublicKeyFalcon512],
                ['nonce', 'u64'],
                ['receiverId', 'string'],
                ['blockHash', [32]],
                ['actions', [Action]]
            ] }],
    [key_pair_1.PublicKeyEd25519, { kind: 'struct', fields: [
                ['keyType', 'u8'],
                ['data', [32]]
            ] }],
    [key_pair_1.PublicKeyFalcon512, { kind: 'struct', fields: [
                ['keyType', 'u8'],
                ['data', [897]]
            ] }],
...
async function signTransactionObject(transaction, signer, accountId, networkId) {
    ...
    switch (transaction.publicKey.keyType) {
        case key_pair_1.KeyType.ED25519:
            console.warn("We are in ED25519");
            ...
            break;
        case key_pair_1.KeyType.FALCON512:
            signedTx = new SignedTransaction({
                transaction,
